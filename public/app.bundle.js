...
/***/ function(module, exports, __webpack_require__) {
	...
	function draw() {
	  if (state.animation.active === true) {
	    ...
	    var move = state.board.history.pop();
	    ...
	    if (!_lodash2.default.isEmpty(state.solving.moves)) {
	      ...
	      (0, _jquery2.default)(canvas).unbind("click");
	      (0, _jquery2.default)("#solveButton").unbind("click");
	    }
	  } else {
	...
	function renderCurrentScore(currentScore) {
	  (0, _jquery2.default)("#moveCounter").html(currentScore);
	}
	...
	function main() {
	  ...
	  (0, _jquery2.default)("#generateButton").click(function (e) {
	    (0, _jquery2.default)("#loading").html("Fetching image!");
	    ...
	    state.img.onload = function (e) {
	      ...
	      // bind solve button
	      (0, _jquery2.default)("#solveButton").click(function (e) {
	        e.preventDefault();
	        solve(state);
	      });

	      // bind hint button
	      (0, _jquery2.default)("#hintButton").click(function (e) {
	        e.preventDefault();
	        hint(state);
	      });
